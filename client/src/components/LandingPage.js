          ...
          <div>
            <div className='quickSearchSide'>
              <h4 className='text-center'>
                Search for a specific location, or browse all of our listings by
                clicking the 'Listings' link above
              </h4>
            </div>
...
export default connect(mapStateToProps, { getItems, searchItems })(LandingPage);
